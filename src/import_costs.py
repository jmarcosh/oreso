...
basic_cost = pd.DataFrame({'STYLE': product_data['STYLE'], 'QUANTITY': product_data['QUANTITY'],
                           ...
                           'RETENTION_MX': unit_retention_mx * 0.1, 'OTHER_CHARGES_MX': unit_other_charges_mx,
...
comprobation = TOTAL_PAYMENTS_MX + transfer_commission_mx + CUSTOMS_RETENTION_MX * 0.1 - \
...
s.write_df_to_excel(basic_cost_save, f'/{RD[:-1]}/{RD}', f"basic_cost_{RD}.xlsx")
